					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="{{asset('frontend/images/home/paracetamol.jpg')}}" class="girl img-responsive" alt="" />
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{asset('frontend/images/home/cold.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{asset('frontend/images/home/pricing.png')}}"  class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{asset('frontend/images/home/inhaler.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{asset('frontend/images/home/pricing.png')}}" class="pricing" alt="" />
								</div>
							</div>
